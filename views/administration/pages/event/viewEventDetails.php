...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      ...
      <!-- Title -->
      <div class="col-sm-6">
        <h1><b>Viendo evento: </b>"<?php echo $result['event_name_of_activity'] ?>"</h1>
      </div>
                                  ...
                                  <select class="form-control"
                                    ...
                                    <?php
                                      foreach ($allUsers as $index => $item) { ?>
                                        <option
                                          <?php if ($item['user_id'] == $result['event_technology_manager_manager']) {
                                            echo 'selected';
                                          }
                                          ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control"
                                    ...
                                    <?php
                                      foreach ($allUsers as $index => $item) { ?>
                                        <option
                                          <?php if ($item['user_id'] == $result['event_manager_social_service']) {
                                            echo 'selected';
                                          }
                                          ?>
                                            value="<?php echo $item['user_id']; ?>">
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control"
                                    ...
                                    <?php
                                      foreach ($allUsers as $index => $item) { ?>
                                        <option
                                          <?php if ($item['user_id'] == $result['event_input_portfolio_manager']) {
                                            echo 'selected';
                                          }
                                          ?>
                                            value="<?php echo $item['user_id']; ?>">
                            ...
                            <div class="card card-olive card-outline sisreg-card-outline">
                              ...
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <?php
                                    $event_date_delivery_date_administrative_offices = strtotime ($result['event_date_delivery_date_administrative_offices']);
                                    $event_date_delivery_date_administrative_offices = date ("d-m-Y H:i:s", $event_date_delivery_date_administrative_offices);
                                  ?>
                                  <div class="input-group date" id="dateDeliveryDateAdministrativeOffices"
                                    ...
                                    <input type="text"
                                           ...
                                           title="<?php echo $event_date_delivery_date_administrative_offices ?>"
                                           value="<?php echo $event_date_delivery_date_administrative_offices ?>"
                                           required/>
                                    <div class="input-group-append"
                                         data-target="#dateDeliveryDateAdministrativeOffices"
                                         data-toggle="datetimepicker">
                                ...
                                <div class="form-group">
                                  ...
                                  <?php
                                    $event_date_creation_opening_registrations_platform_course = strtotime ($result['event_date_creation_opening_registrations_platform_course']);
                                    $event_date_creation_opening_registrations_platform_course = date ("d-m-Y H:i:s", $event_date_creation_opening_registrations_platform_course);
                                  ?>
                                  <div class="input-group date"
                                    ...
                                    <input type="text"
                                           ...
                                           title="<?php echo $event_date_creation_opening_registrations_platform_course ?>"
                                           value="<?php echo $event_date_creation_opening_registrations_platform_course ?>"
                                           required/>
                                    <div class="input-group-append"
                                         data-target="#dateCreationOpeningRegistrationsPlatformCourse"
                                         data-toggle="datetimepicker">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group date"
                                    ...
                                    <input type="text"
                                           ...
                                           title="Fecha de entrega de concentrados y constancias para validación"
