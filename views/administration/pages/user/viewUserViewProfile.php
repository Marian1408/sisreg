<?php
  ...
  require_once ('controllers/controllerUser.php');
   ...
   if (isset($_POST['userData'])) {
     ...
     $dataUser = $objectUser->getUserById ($_POST['userData']);
   }else{
     $objectUser = new ControllerUser();
     $dataUser = $objectUser->getUserById ($_SESSION['user_id']);
   }
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="Usuario"
                                   value="<?php echo $dataUser['user_username']; ?>">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="Nombre"
                                   value="<?php echo $dataUser['user_name']; ?>" >
                          ...
                          <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   value="<?php echo $dataUser['user_last_name']; ?>">
                            ...
                            <select class="form-control"
                              ...
                              <?php
                                ...
                                foreach ($result as $index => $item) { ?>
                                  <option
                                      <?php if($item['user_role_id'] == $dataUser['user_role']){
                                        echo 'selected';
                                      } ?>
                                      
                                      value="<?php echo $item['user_role_id']; ?>">
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="email"
                                   ...
                                   value="<?php echo $dataUser['user_mail']; ?>">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   value="<?php echo $dataUser['user_phone']; ?>">
                          ...
                          <div class="form-group">
                            <div class="form-group">
                              ...
                              <textarea id="textAreaDescription"
                                        ...
                                        class="form-control"
                                        rows="4"
                                        placeholder="Información extra..."><?php echo $dataUser['user_description']; ?></textarea>
                      ...
                      <div class="card card-olive card-outline sisreg-card-outline">
                        ...
                        <div class="card-body">
                          ...
                          <div class="text-center">
                            <img src="<?php echo $dataUser['user_image']; ?>"
                                 class="img-thumbnail"
                                 id="imageUser"
                                 alt="...">
