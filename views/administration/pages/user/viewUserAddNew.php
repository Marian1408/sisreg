    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card card-secondary ">
          ...
          <!-- Card header -->
          <div class="card-header sisreg-card-darkgreen">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-4 mb-10">
                  ...
                  <div class="card card-lightblue card-outline sisreg-card-outline">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               placeholder="Usuario">
                        <div id="inputUsernameHelp" class="form-help">Escribe un nombre de usuario para iniciar sesión.</div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div id="inputPasswordHelp"
                             class="form-help">Escribe una contraseña.</div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div id="inputLastnameHelp"
                             class="form-help">El apellido del usuario.</div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div id="selectRoleHelp" class="form-help">El rol del usuario limita los permisos para ver o utilizar ciertas funciones.</div>
                      </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email"
                               ...
                               placeholder="El correo electrónico debe ser válido.">
              ...
              <button type="button"
                      class="btn btn-danger btn-flat cltm-tools-buttons"
                      title="Añadir usuario"
                      onclick="addUserAjax()">
          ...
          <!-- Card footer -->
          <div class="card-footer text-right bg-lightblue sisreg-card-darkgreen">
            <em>COLPOS</em>
          </div>
